...
_SAFETY_WORDS = lexicon.SECURITY          # the one security vocabulary (app/routing/lexicon.py)
...
def get_provider_router() -> ProviderRouter:
    ...
    for provider_type in (MobulaWalletProvider, MobulaSecurityProvider, MobulaMemeProvider, ExchangeListingsProvider, ListedAssetProvider, RedditCrowdProvider, PolymarketProvider):
