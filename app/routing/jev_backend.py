...
SPEECH_ACTS = {
    ...
    "app": "Asks this product to operate itself, no look-up: save or export this investigation or a report, a watchlist, alert or notification settings. 'save this investigation', 'show my token watchlist ranked by changes'.",
